...
class splitbase():
    ...
    def saveimagepatches(self, img, subimgname, left, up):
        ...
        outdir = os.path.join(self.outimagepath, subimgname + self.out_format)
        print(outdir)
...
if __name__ == '__main__':
    ...
    # split = splitbase(r'/home/liu/datasets/dota1.5/semi/split_20_1/label_png',
    #                    r'/home/liu/datasets/dota1.5/semi/split_20_1/label',
    #                   gap=200,
    #                   subsize=1024,
    #                   num_process=8,
    #                   out_format='.jpg'
    ...
    #
    #
    # split = splitbase(r'/home/liu/datasets/dota1.5/semi/split_20_1/unlabel_png',
    #                    r'/home/liu/datasets/dota1.5/semi/split_20_1/unlabel',
    #                   gap=200,
    #                   subsize=800,
    #                   num_process=8,
    #                   out_format='.jpg'
    ...
    split = splitbase(r'/home/liu/datasets/dota1.5/train',
                       r'/home/liu/datasets/chuan/dota',
                      gap=50,
                      subsize=512,
                      num_process=1,
                      out_format='.jpg'
